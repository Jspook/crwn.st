...
async function GET() {
    ...
    try {
        const carts = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["readData"])("cart.json");
        const userCart = carts.find((c)=>c.userId === session.id);
...
async function POST(request) {
    ...
    try {
        ...
        const carts = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["readData"])("cart.json");
        const cartIndex = carts.findIndex((c)=>c.userId === session.id);
        if (cartIndex > -1) {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["writeData"])("cart.json", carts);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true
        });
    } catch (error) {
...
async function DELETE() {
    ...
    try {
        const carts = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["readData"])("cart.json");
        const filteredCarts = carts.filter((c)=>c.userId !== session.id);
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["writeData"])("cart.json", filteredCarts);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1s0-fao._.js.map