...
async function POST(request) {
    try {
        ...
        const users = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["readData"])("users.json");
        let matchedUser;
        if (loginType === "staff") {
            matchedUser = users.find((u)=>u.username === identifier && u.password === password && (u.role === "CASHIER" || u.role === "FITTING_STAFF"));
        } else if (loginType === "customer") {
            matchedUser = users.find((u)=>u.phone === identifier && u.role === "CUSTOMER");
        }
        if (!matchedUser) {
        ...
        // Create session
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$session$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createSession"])({
            id: matchedUser.id,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__04ix484._.js.map